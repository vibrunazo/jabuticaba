...
const pt = {
  ...
  "item.placeCountHint":
    "Soma dos pesos de cada lugar: ampla = {widespread}, regional = {regional}, marginal = {marginal}.",
  ...
  "level.imported": "Só importado do Brasil",
...
const en: Record<UiKey, string> = {
  ...
  "item.placeCountHint":
    "Sum of each place's weight: widespread = {widespread}, regional = {regional}, marginal = {marginal}.",
  ...
  "level.regional": "Regional",
  "level.marginal": "Marginal",
  "level.imported": "Only imported from Brazil",
