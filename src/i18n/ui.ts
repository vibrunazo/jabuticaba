...
const pt = {
  ...
  "methodology.eyebrow": "Metodologia · v{version}",
  "methodology.updated": "Atualizada em {date}",
  "methodology.codeAndData": "Código e dados",
  "methodology.repository": "Repositório no GitHub",
  "methodology.results": "Resultados em CSV",
  "methodology.license": "Licença: domínio público (CC0)",
  "ranking.rank": "{rank}º",
...
const en: Record<UiKey, string> = {
  ...
  "methodology.eyebrow": "Methodology · v{version}",
  "methodology.updated": "Updated {date}",
  "methodology.codeAndData": "Code and data",
  "methodology.repository": "GitHub repository",
  "methodology.results": "Results as CSV",
  "methodology.license": "License: public domain (CC0)",
  "ranking.rank": "#{rank}",
